...
logging.basicConfig()
log = logging.getLogger("RandomServer")
log.setLevel(logging.INFO)


class RandomServer:
    """
    A simple random server for testing.
    ...
    Addr:1-999 (0x0001-0x03E7) -> random % 2
    ...
    async def __random_loop(self) -> None:
        ...
        while self.running:
            ...
            for slave_id in self.context.slaves():
                ...
                random_values = [i % 2 for i in random_values]
                slave.setValues(OUTPUT_COILS, 1, random_values)
                slave.setValues(INPUT_CONTACTS, 1, random_values)
